...
- 用户角色 = 触发者; 本地 build 通过即自主走完 deploy (commit/tag/push/发版), MUST NOT 等人类验收; 功能由人类发版后手测, 不阻塞发布; MUST NOT 拉人类进设计回路
...
- 无自动化测试 / 不运行 app; **本地 build 通过 = 唯一发版门禁**, MUST NOT 等人类手测; 功能由人类发版后自行手测; Actions 侧再编译一次仅作冗余保险
